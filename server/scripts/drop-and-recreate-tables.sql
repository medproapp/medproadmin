...
DROP VIEW IF EXISTS v_active_products_with_prices;
DROP VIEW IF EXISTS v_sync_status_summary;
DROP TABLE IF EXISTS product_sync_queue;
DROP TABLE IF EXISTS product_sync_conflicts;
DROP TABLE IF EXISTS product_audit_log;
DROP TABLE IF EXISTS product_metadata_templates;
DROP TABLE IF EXISTS stripe_sync_history;
DROP TABLE IF EXISTS v3_recovery_log;
DROP TABLE IF EXISTS admin_audit_log;
DROP TABLE IF EXISTS product_prices;
DROP TABLE IF EXISTS product_catalog;
DROP TABLE IF EXISTS admin_permissions;

-- Now create tables according to our design
...
CREATE VIEW v_active_products_with_prices AS
SELECT 
    p.*,
...
CREATE VIEW v_sync_status_summary AS
SELECT 
